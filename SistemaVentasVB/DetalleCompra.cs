...
namespace SistemaVentasVB
{
    ...
    public partial class DetalleCompra
    {
        ...
        {
            string conexion = "Server=DESKTOP-R538THL;Database=SistemaVentas; Integrated Security=True;";
        ...
        {
            var cnn = new SqlConnection("Server=DESKTOP-R538THL;Database=SistemaVentas; Integrated Security=True;");
